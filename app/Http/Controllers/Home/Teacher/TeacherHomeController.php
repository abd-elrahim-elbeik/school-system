...
class TeacherHomeController extends Controller
{
    ...
    public function student()
    {
        ...
        // $student_id = Attendance::where('attendence_date',$date)->where('student_id',auth()->user()->id)->first();
        // return auth()->user()->id;
    ...
    public function editAttendance(Request $request){
        ...
        try{
            ...
            if( $request->attendences == 'presence' ) {
                $new_attendence_status = true;
            } else if( $request->attendences == 'absent' ){
                $new_attendence_status = false;
            }
            $student_id->update([
                'attendence_status'=> $new_attendence_status
            ]);
            toastr()->success(trans('messages.success'));
            return redirect()->back();
        }
